...
%     m = M(k);
    ...
    for j = 1:m 
        ...
        for i = 1:length(x)
            scatter(x(i), y(i), small, type{mymod(i, 13)})
            hold on;
        end
        axis([0 1 0 1])
        xlabel('precision');
...
%legend('C4.5 (pruned no iterations)', 'C4.5 (unpruned)', 'C4.5 (pruned)', 'AdaBoost C4.5 (10x)', 'AdaBoost C4.5 (25x)', 'Furia', 'Random Forest (25)', 'Random Forest (50)', 'Random Forest (50-5)', 'LogitBoost Random Forest (10x10)', 'JRip', 'AdaBoost JRip (10)', 'AdaBoost JRip (25)', 'Bagging C4.5 (25)', 'Naive Bayes', 'SVM', 'kNN', 'Tuned C4.5 (unpruned)');
