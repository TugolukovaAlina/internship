function [samples, selectedSamples, samplesBeforeJump, samplesAfterJump, numberOfJumps, newJumps, samplesTaken] = stepRestartMaxDegree(graph, numberOfSamples, alpha)
